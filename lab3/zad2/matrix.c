...
void get_dims(FILE *matrix_file, int *rows, int *cols)
{
...
matrix load_matrix(char *filename)
{
  ...
  int rows, cols;
  get_dims(matrix_file, &rows, &cols);
...
int main(int argc, char *argv[])
{
  ...
  generate_matrix(a_rows, a_cols, "A");
  generate_matrix(a_cols, b_cols, "B");
